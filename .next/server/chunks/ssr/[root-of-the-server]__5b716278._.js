...
function OrdersPage() {
    ...
    const apiPatchStatus = async (orderId, status, token)=>{
        const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].patch(`/api/restaurants/orders/${orderId}/status/`, {
            status
        }, {
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5b716278._.js.map