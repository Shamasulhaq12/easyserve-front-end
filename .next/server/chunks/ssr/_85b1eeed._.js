module.exports = [
"[project]/src/lib/websocket.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

async function connectOrderSocket(getAccessToken, onMessage) {
    let token = await getAccessToken(); // refresh if needed
    const backendWs = ("TURBOPACK compile-time value", "ws://localhost:8000");
...
"[project]/src/hooks/useOrderSocket.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$websocket$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/websocket.js [app-ssr] (ecmascript)");
"use client";
;
;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useOrderSocket$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useOrderSocket.js [app-ssr] (ecmascript)");
...
;
function OrdersPage() {
    const { data: initialOrders, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$private$2f$orders$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGetOrderStatusQuery"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useOrderSocket$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])((payload)=>{
        if (payload.order) {
            setOrders((prev)=>{
                const exists = prev.find((x)=>x.id === payload.order.id);
                return exists ? prev.map((x)=>x.id === payload.order.id ? payload.order : x) : [
                    payload.order,
                    ...prev
                ];
            });
...
//# sourceMappingURL=_85b1eeed._.js.map