module.exports = [
"[project]/src/lib/websocket.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function connectOrderSocket(token, onMessage) {
    ...
    const wsUrl = `${wsProtocol}://${window.location.host}/ws/orders/?token=${token}`;
...
function OrdersPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const socket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$websocket$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["connectOrderSocket"])(token, (payload)=>{
            if (payload.order) {
                setOrders((prev)=>{
    ...
    const apiPatchStatus = async (orderId, status, token)=>{
        const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].patch(`/api/dashboard/orders/${orderId}/status/`, {
            status
        }, {
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b3345963._.js.map