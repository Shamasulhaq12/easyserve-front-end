...
;
;
function ReviewModal({ open, onClose, tableNumber }) {
...
function TableCard({ table }) {
    const { number, status, customers, orderItems, orderTime } = table;
...
const { useGetWaiterDashboardQuery } = waiterApi;
}),
...
function DashboardPage() {
    const { data, isLoading, isError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$private$2f$waiter$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGetWaiterDashboardQuery"])();
...
//# sourceMappingURL=src_74503d86._.js.map