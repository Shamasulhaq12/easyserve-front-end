...
"[project]/src/lib/websocket.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function connectOrderSocket(getAccessToken, onMessage) {
    ...
    const wsUrl = "".concat(backendWs, "/ws/orders/?token=").concat(token);
...
"[project]/src/hooks/useOrderSocket.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useOrderSocket(onMessage) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useOrderSocket.useEffect": ()=>{
            const token = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem("token") : "TURBOPACK unreachable";
            if (!token) return;
            socketRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$websocket$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["connectOrderSocket"])(token, {
                "useOrderSocket.useEffect": (payload)=>{
...
_s(useOrderSocket, "8c0rAI93JE8jpOVTnobt43KkFfY=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useOrderSocket$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useOrderSocket.js [app-client] (ecmascript)");
...
function OrdersPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useOrderSocket$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        "OrdersPage.useOrderSocket": (payload)=>{
            if (payload.order) {
                setOrders({
                    "OrdersPage.useOrderSocket": (prev)=>{
                        const exists = prev.find({
                            "OrdersPage.useOrderSocket.exists": (x)=>x.id === payload.order.id
                        }["OrdersPage.useOrderSocket.exists"]);
                        return exists ? prev.map({
                            "OrdersPage.useOrderSocket": (x)=>x.id === payload.order.id ? payload.order : x
                        }["OrdersPage.useOrderSocket"]) : [
                            payload.order,
                            ...prev
                        ];
                    }
...
_s(OrdersPage, "T8vax1JhRbPTqhBeLOWCZ1+lTzk=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useOrderSocket$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
...
//# sourceMappingURL=_08f14be7._.js.map