...
function OrdersPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrdersPage.useEffect": ()=>{
            ...
            const socket = connectOrderSocket(token, {
    ...
    const apiPatchStatus = async (orderId, status, token)=>{
        const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch("/api/restaurants/orders/".concat(orderId, "/status/"), {
            status
        }, {
            headers: {
...
//# sourceMappingURL=src_app_admin_orders_page_jsx_2f30cac7._.js.map