        ...
        if (refreshResult.data) {
            ...
            api.dispatch({
                ...
                payload: {
                    ...
                    refresh,
                    user_type: (_api_getState_auth_user = api.getState().auth.user) === null || _api_getState_auth_user === void 0 ? void 0 : _api_getState_auth_user.user_type
                }
            });
    ...
    endpoints: (build)=>({
            ...
            patchOrderStatus: build.mutation({
                query: (param)=>{
                    ...
                    return {
                        url: "/dashboard/orders/".concat(orderId, "/status/"),
                        method: "PATCH",
                        body: {
                            status
                        }
...
"[project]/src/app/layoutClient.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_1aa99bc8._.js.map